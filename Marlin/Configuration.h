...
#define STRING_CONFIG_H_AUTHOR "(Ofir_Pardo, Anet ET4 TMC2208 BMG)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anet ET4 TMC2208 BMG V1.5"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.30, 80.02, 400.25, 400.3 }
